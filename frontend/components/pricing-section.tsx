...
export function PricingSection() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      features: [
        "Advanced error detection with AI analysis",
        "Smart notification routing to specific team members",
        "Multi-environment monitoring (dev, staging, prod)",
        "Up to 100,000 errors/month",
        "Automated incident reports with stack traces",
        "Fault tolerance system with auto-recovery",
    ...
    },
    {
      ...
      features: [
        "Unlimited error tracking across all environments",
        "Custom notification rules and escalation paths",
        "Dedicated incident response team",
        "Advanced fault tolerance with custom recovery logic",
        "SLA guarantees with 99.9% uptime monitoring",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing built for every team size
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your error monitoring needs, from small projects <br /> to enterprise-scale
            applications.
          </p>
        </div>
        <div className="pt-4">
